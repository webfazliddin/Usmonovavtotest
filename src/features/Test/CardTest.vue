...
// Keyboard shortcuts for F1-F12, Number keys, Arrow keys, and Enter
const handleKeyPress = (event: KeyboardEvent) => {
  ...
  // F1-F12 keys - only work if no answer selected yet
...
.test-content {
  flex: 1;
  padding: 32px;
  padding-bottom: 80px; // Space for footer only
  overflow-y: auto;
}
